...
class MapData(commands.Cog):
    ...
    async def get_map_data(self, interaction: discord.Interaction, map_name: str):
        api_response = requests.get(f"https://quanteey.xyz/Overcast%20Community/maps/{map_name}")
        ...
        map_avg_playercount_change = api_response.json()["map_avg_playercount_change"]
